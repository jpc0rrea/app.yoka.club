...
export const createTrailFormSchema = z.object({
  title: z
    .string({
...
export type CreateTrailFormData = z.infer<typeof createTrailFormSchema>;
...
export default function CreateTrailModal() {
  ...
  const form = useForm<CreateTrailFormData>({
    resolver: zodResolver(createTrailFormSchema),
    defaultValues: {
      eventIds: [],
    },
  });
  ...
  const handleCreateTrail = async (data: CreateTrailFormData) => {
    try {
      await api.post('/admin/trails', {
        ...data,
      });
      ...
      successToast({
        ...
        description: 'sua trilha já está disponível',
      });
            ...
            <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
              ...
              >
                <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-white px-4 pb-4 pt-5 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-2xl sm:p-6">
                  ...
                  <Form {...form}>
                    <form
                      onSubmit={form.handleSubmit(handleCreateTrail)}
                      className="space-y-6"
                    >
                      <FormField
